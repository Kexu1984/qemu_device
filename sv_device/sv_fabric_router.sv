// Functional fabric request/response router for SV bus masters.
//
// This module captures the stable SV-side fabric port shape. The current RTL
// path still uses sv_master_router.sv; future integration can replace or wrap
// that router with this module when cross-domain decode is enabled.
module sv_fabric_router (
    input  logic        req_valid_i,
    output logic        req_ready_o,
    input  logic        req_write_i,
    input  logic [7:0]  req_master_id_i,
    ...
    output logic [7:0]  ext_req_master_id_o,
    ...
    assign ext_req_master_id_o = req_master_id_i;
